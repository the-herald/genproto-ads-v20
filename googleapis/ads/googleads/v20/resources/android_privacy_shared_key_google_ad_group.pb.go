...
type AndroidPrivacySHAREDKeyGoogleAdGroup struct {
	...
	SHARED_ad_group_key,json=SHARED_ad_group_key,omitempty"`
...
func (x *AndroidPrivacySHAREDAdGroupKey() string {
	if x != nil {
...
const file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_rawDesc = "" +
	...
	"\x13SHAREDAdGroupKey:\x84\x02\xeaA\x80\x02\n" +
	"=googleads.googleapis.com/AndroidPrivacySHAREDKeyGoogleAdGroups/{campaign_id}~{ad_group_id}~{android_privacy_interaction_type}~{android_privacy_network_type}~{android_privacy_interaction_date}B\x9b\x02\n" +
...
func file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_rawDesc), len(file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_rawDesc)))
	})
...
func file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_android_privacy_SHARED_key_google_ad_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
